...
#include "interfaces/msg/detail/posicion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Posicion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Posicion & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Posicion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Posicion *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Posicion(full_bounded, 0);
}
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Posicion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Posicion)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Posicion__handle;
}
