...
#include "interfaces/msg/detail/posicion__rosidl_typesupport_fastrtps_c.h"
...
using _Posicion__ros_msg_type = interfaces__msg__Posicion;
...
size_t get_serialized_size_interfaces__msg__Posicion(
  const void * untyped_ros_message,
...
static uint32_t _Posicion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Posicion(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Posicion(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Posicion__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_interfaces__msg__Posicion(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Posicion)() {
